...
if __name__ == '__main__':
    ...
    #
    train['Family_Hist_2'][pd.isnull(train['Family_Hist_2'])] = np.mean(train['Family_Hist_2'])
    test['Family_Hist_2'][pd.isnull(test['Family_Hist_2'])] = np.mean(test['Family_Hist_2'])
    ##Medical_History_15
    
    train['Employment_Info_6'][pd.isnull(train['Employment_Info_6'])] = np.mean(train['Employment_Info_6'])
    test['Employment_Info_6'][pd.isnull(test['Employment_Info_6'])] = np.mean(test['Employment_Info_6'])

    train['Medical_History_15'][pd.isnull(train['Medical_History_15'])] = -1
    test['Medical_History_15'][pd.isnull(test['Medical_History_15'])] = -1
    train['Medical_History_1'][pd.isnull(train['Medical_History_1'])] = np.median(train['Medical_History_1'])
    test['Medical_History_1'][pd.isnull(test['Medical_History_1'])] = np.median(test['Medical_History_1'])
