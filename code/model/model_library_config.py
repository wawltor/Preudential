...
param_space_reg_xgb_tree_count = {
    ...
    'max_delta_step':hp.quniform('max_delta_step',0.5,1,0.1),
...
param_space_reg_xgb_linear_count = {
    'task': 'regression',
    'booster': 'gblinear',
    'objective': 'reg:linear',
    'lambda' : hp.quniform('lambda', 0, 5, 0.05),
    'alpha' : hp.quniform('alpha', 0, 2, 0.005),
    'lambda_bias' : hp.quniform('lambda_bias', 0, 1, 0.001),
    'num_round' : hp.quniform('num_round', xgb_min_num_round, xgb_max_num_round, xgb_num_round_step),
    'nthread': xgb_nthread,
    'silent' : 1,
    'early.stop.round':10,
...
param_space_reg_xgb_linear = {
    ...
    'lambda' : hp.quniform('lambda', 0, 5, 0.05),
    'alpha' : hp.quniform('alpha', 0, 2, 0.005),
    'lambda_bias' : hp.quniform('lambda_bias', 1, 2, 0.1),
    'num_round' : hp.quniform('num_round', xgb_min_num_round, xgb_max_num_round, xgb_num_round_step),
    'nthread': xgb_nthread,
    'silent' : 1,
    'early.stop.round':10,
...
feat_name = "param_space_reg_xgb_linear"
param_spaces[feat_name] = param_space_reg_xgb_linear
feat_name = "param_space_clf_skl_lr"
...
feat_name = "param_space_reg_xgb_tree"
...
feat_name = "param_space_reg_xgb_linear_count"
param_spaces[feat_name] = param_space_reg_xgb_linear_count
...
feat_name = "param_space_reg_skl_svr"
param_spaces[feat_name] = param_space_reg_skl_svr
feat_name = "param_space_reg_skl_ridge"
param_spaces[feat_name] = param_space_reg_skl_ridge
feat_name = "param_space_reg_skl_lasso"
